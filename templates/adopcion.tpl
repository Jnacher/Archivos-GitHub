...
<meta name="descripción" 	content="Insercion de anuncios de adopcion a mascotas, animales, perros, gatos, caballos, peces, conejos...">
<meta name="palabras clave" content="adopta, criadero, adiestra, adopta perros, adopta cachorros">
     ...
     $.post("ajax.php", { idImg: $this.attr('rel') },
	   function(data){
		 if(data='ok'){
		   $this.remove();
		   numImg--;
		   window.location='http://localhost/Perro/adopciones.php?idAn='+idAn;
...
<div class="contenedorForm">
  ...
  <div class="formularioTitulo">1. Pon tu anuncio gratis ¡en solo 1 minuto!</div>
    ...
    <form id="registro" name="form1" method="post" enctype="multipart/form-data" action="adopciones.php" onsubmit="return compForm();">
    {$edita}
    ...
    <ul>
        ...
        <li>
            ...
            <input  name="sexo" type="radio" id="h" value="h" {$fimale}/>
            <label for="h">Hembra:</label>
            <input type="radio" name="sexo" id="m" value="m" {$male}/>
        ...
        <li id="vacunas-li">
            ...
            <span class= "formInputRadio">
            <input name="vacunas" type="radio" id="sV" value="s" {$vacunaSi} />
            <label for="s">Si:</label>
            <input type="radio" name="vacunas" id="nV" value="n" {$vacunaNo} />
        ...
        <li>
            <label class= "formLabel" for="tamano">Tamaño</label>
            <select class= "formInput" name="tamano" id="tamano">
            <option value="0">Selecciona</option>
            <option value="g" {$g}>Grande</option>
            <option value="m" {$m}>Mediano</option>
            <option value="p" {$p}>Pequeño</option>
            </select>
        </li>
        {$error.tamano}
        ...
        <li id="desparasitados-li">
            ...
            <span class= "formInputRadio">
            <input name="desparasitados" type="radio" id="sD" value="s" {$desparasitadosSi} />
            <label for="s">Si:</label>
            <input type="radio" name="desparasitados" id="nD" value="n" {$desparasitadosNo}/>
            <label for="n">No:</label>
            </span>
        </li>
        <li>
