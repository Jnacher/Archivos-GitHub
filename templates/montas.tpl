...
<title>Anuncio simple compra y venta</title>
<meta name="descripción" 	content="Insertar anuncios de compra y venta de mascotas, animales, perros, gatos, caballos, peces, conejos...">
<meta name="palabras clave" content="compra, venta, insertar anuncio, gratis">
...
<div class="contenedorForm">
  ...
  <div class="formularioTitulo">1. Pon tu anuncio gratis ¡en solo 1 minuto!</div>
    ...
    <form id="registro" name="form1" method="post" enctype="multipart/form-data" action="montas.php" onsubmit="return compForm();">
    {$edita}
    ...
    <ul>
        ...
        {$error.titulo}	
         <li>
            <label class= "formLabel" for="interes">Interes:</label>
            <input name="interes" type="text" class= "formInput" placeholder="ej:Un cachorro" id="interes" value="{$interes}" />
        </li> 
        {$error.interes}	
