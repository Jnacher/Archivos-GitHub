...
<meta name="palabras clave" content="compra, perro, material, seguna mano">
<meta name="keywords" 		content="segunda mano, segundamano, anuncios"/>
...
<div class="contenedorForm">
              ...
              <form name="buscar" id="buscar" method="post" action="materialVi.php">
            <ul class="menuUl">
...
<div id="contactar-popUp">
 ...
 <form METHOD="post" action="materialVi.php" onSubmit="return compForm('c')" class="contacto">
  <div id="campos"> 
    <div class="contacto">
...
<div class="envioPrincipal">
 <form METHOD="post" action="materialVi.php" onSubmit="return compForm('a')" class="contacto">
...
<div id="denunciar-popUp">
			<h3>Formulario de contacto</h3>
			<div class="contactoPrincipal">
 <form METHOD="post" action="materialVi.php"  class="contacto">
  <div id="campos"> 
    <div class="contacto">
