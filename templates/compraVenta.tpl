...
<meta name="palabras clave" content="compra mascotas, perro gratis, compra perros, venta perros, compra cachorros, venta cachorros">
<meta name="keywords" 		content="compra y venta, compraventa, compra perros"/>
...
<div class="contenedorForm">
  ...
  <div class="formularioTitulo">1. Pon tu anuncio gratis ¡en solo 1 minuto!</div>
    ...
    <form id="registro" name="form1" method="post" enctype="multipart/form-data" action="compraVenta.php" onsubmit="return compForm();">
    {$edita}
