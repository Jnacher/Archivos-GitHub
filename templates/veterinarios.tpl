...
<meta name="descripción" 	content="Anuncios de veterinarios de mascotas, animales, perros, gatos, caballos, peces, conejos...">
<meta name="palabras clave" content="veterinarios, telefono, email, direccion, web">
...
<div class="contenedorDentroInicio">
    <div class="menu">
                ...
                <span style="margin-right:20px;">Elige tu ciudad</span>
                	<form name="buscar" id="buscar" method="post" action="veterinarios.php">
    ...
    <div class="muestraPerreras">
          Busca los veterinarios de tu ciudad »
    </div>
     ...
     <div class="cabeceraProtectoras">
        ...
        <div class="tres">Web del veterinario</div>
