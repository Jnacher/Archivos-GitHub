  ...
  <div class="formularioTitulo">1. Pon tu anuncio gratis ¡en solo 1 minuto!</div>
    ...
    <li>
          ...
          <span class= "formInputRadio">
            <input name="tipoCliente" type="radio" id="Pro" value="Pro" class="eres" {$profesional} />
            <label for="Pro">Profesional</label>
            <input type="radio" name="tipoCliente" id="Par" value="Par" class="eres" {$particular} />
         ...
         <li id="tipo">
          ...
          <span class= "formInputRadio">
            ...
            <input name="tipoCliente2" type="radio" id="Emp" class="eres1" value="Emp" {$eresCheck.empresa} />
            <label for="Emp">Empresa</label>
            
            <input type="radio" name="tipoCliente2" id="Prot" class="eres1" value="Prot" {$eresCheck.protectora} />
            <label for="Prot">Protectora</label><br />

             <input type="radio" name="tipoCliente2" id="Cri" class="eres1" value="Cri" {$eresCheck.criador} />
            <label for="Cri">Criador</label>
            
            <input style="margin-left:14px;" type="radio" name="tipoCliente2" id="Vet" class="eres1" value="Vet" {$eresCheck.veterinario} />
        ...
        <li style="margin-top:15px;">
            ...
            <input class= "formInput" type="text" name="nombre" id="nombre" value="{$nombre}"  onblur="valida(this.value);"/>
        </li>
        ...
        <li class="Emp profes">
            ...
            <input class= "formInput" type="text" name="nombreEmpresa" id="nombreEmpresa" value="{$nombreEmpresa}"  onblur="valida(this.value);"/>
        </li>
        <li class="Emp profes">{$error.nombreEmpresa}</li>
        
        <li class="Emp profes">
        	<label class= "formLabel" for="webEmpresa">Web empresa:</label>
            <input class= "formInput" name="webEmpresa" type="text" id="webEmpresa" value="{$http}{$webEmpresa}"  autocomplete="off" />
        </li>
        <li class="Emp profes">{$error.webEmpresa}</li>
        
        <!--//////////////////////Protectora//////////////////////////-->
        
         <li class="Prot profes">
        	<label class= "formLabel" for="nomProtectora">Nombre protectora:</label>
            <input class= "formInput" name="nomProtectora" type="text" id="nomProtectora" value="{$nomProtectora}"  autocomplete="off" />
        </li>
       <li class="Prot profes">{$error.nomProtectora}</li>
        
        <li class="Prot profes">
        	<label class= "formLabel" for="webProtectora">Web protectora:</label>
            <input class= "formInput" name="webProtectora" type="text" id="webProtectora" value="{$http}{$webProtectora}"  autocomplete="off" />
        </li>
        <li class="Prot profes">{$error.webProtectora}</li>
        ...
        <!--//////////////////////criador//////////////////////////-->
         ...
         <li class="Cri profes">
            ...
            <input class= "formInput" name="nomCriador" type="text" id="nomCriador" value="{$nomCriador}"  autocomplete="off" />
        </li>
       <li class="Cri profes">{$error.nomCriador}</li>
        
        <li class="Cri profes">
        	<label class= "formLabel" for="webCriador">Web criador:</label>
            <input class= "formInput" name="webCriador" type="text" id="webCriador" value="{$http}{$webCriador}"  autocomplete="off" />
        </li>
        <li class="Cri profes">{$error.webCriador}</li>
         ...
         <li class="Vet profes">
            ...
            <input class= "formInput" name="nomVeterinario" type="text" id="nomVeterinario" value="{$nomVeterinario}"  autocomplete="off" />
        </li>
       <li class="Vet profes">{$error.nomVeterinario}</li>
        
        <li class="Vet profes">
        	<label class= "formLabel" for="webVeterinario">Web Veterinario:</label>
            <input class= "formInput" name="webVeterinario" type="text" id="webVeterinario" value="{$http}{$webVeterinario}"  autocomplete="off" />
        </li>
        <li class="Vet profes">{$error.webVeterinario}</li>
        ...
        <li>
         <label class= "formLabel" for="mail">e-mail:</label>
            <input class= "formInput" type="text" name="email" id="email" value="{$email}" onblur="compEmail(this.value)"/>
        </li>
        ...
        <li>
            ...
            <input class= "formInput"name="telefono" type="text" id="telefono" value="{$telefono}" onBlur="compTel(this.value)" autocomplete="off" />
        </li>
        ...
        <li>
            ...
            <input class= "formInput"name="pass" type="text" id="pass" value="{$pass}" onBlur="compPass(this.value)" autocomplete="off" />
        </li>
        <li ><span id="errorPass" class="errores">Compruebe la contraseña, no es correcta</span></li>
         <li>
            ...
            <input class= "formInput"name="pass2" type="text" id="pass2" value="{$pass2}" onBlur="compPass2(this.value)" autocomplete="off" />
        </li>
