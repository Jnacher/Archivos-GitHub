...
<meta name="descripción" 	content="Anuncios de compra y venta de mascotas, animales, perros">
<meta name="palabras clave" content="compra, perro, gato, pura raza">
<meta name="keywords" 		content="compra venta de perros, compraventadeperros, compraperro"/>
...
<div class="contenedorForm">
            ...
            <ul class="menuUl">
             ...
             <ul class="menuUl">
                ...
                <span class="menuRef">Vendedor</span>
                  <span class= "formInputRadio">
                    <input name="tipoCliente" type="radio" id="Pro" value="pro" {$pro} />
                    <label for="Pro">Profesional:</label>
                    <input type="radio" name="tipoCliente" id="Par" value="par" {$par} />
                    <label for="Par">Particular:</label>
                    <input type="radio" name="tipoCliente" id="both"  value="both" {$bothTC} />
                ...
                <span class="menuRef">Sexo</span>
                    <span class= "formInputRadio">
                    <input  name="sexo" type="radio" id="h" value="h" {$sexH} />
                    <label for="h">Hembra:</label>
                    <input type="radio" name="sexo" id="m" value="m" {$sexM} />
                    <label for="m">Macho:</label>
                     <input type="radio" name="sexo" id="both"  value="both" {$bothSx} />
                    <label for="both">Ambos</label>
                    </span>
                </li>
             </ul>
             <ul class="menuUl">
                <li class="menuLinea">
                <span class="menuRef">Ordenar precio</span>
                    <span class= "formInputRadio">
                    <input  name="precio" type="radio" id="As" value="asc" {$asc} />
                    <label for="As">Ascendente:</label>
                    <input type="radio" name="precio" id="Des" value="desc" {$desc}/>
                ...
                <span class="menuRef">Publicado</span>
                    ...
                    <option value="1" {$1}>en el último dia</option>
                    <option value="3" {$3}>en los últimos 3 dias</option>
                    <option value="5" {$5}>en los últimos 5 dias</option>
                    <option value="10" {$10}>en los últimos 10 dias</option>
                    <option value="15" {$15}>en los últimos 15 dias</option>
                    <option value="20" {$20}>en los últimos 20 dias</option>
                    <option value="30" {$30}>en los últimos 30 dias</option>
                    <option value="60" {$60}>en los últimos 60 dias</option>
                    <option value="90" {$90}>en los últimos 90 dias</option>
                    <option value="120" {$120}>en los últimos 120 dias</option>
                    </select>
                </li>
...
<div id="contactar-popUp">
 ...
 <form METHOD="post" action="compraVentaVi.php" onSubmit="return compForm('c')" class="contacto">
  <div id="campos"> 
    <div class="contacto">
...
<div class="envioPrincipal">
 <form METHOD="post" action="compraVentaVi.php" onSubmit="return compForm('a')" class="contacto">
...
<div id="denunciar-popUp">
			<h3>Formulario de contacto</h3>
			<div class="contactoPrincipal">
 <form METHOD="post" action="compraVentaVi.php"  class="contacto">
  <div id="campos"> 
    <div class="contacto">
