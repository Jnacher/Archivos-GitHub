...
<title>Montas</title>
<meta name="descripción" 	content="Anuncios de buscar novia o novio (montas) para mascotas, animales, perros, gatos, caballos, peces, conejos...">
<meta name="palabras clave" content="montas, cachorro, animal, anuncios">
...
<div id="contactar-popUp">
 ...
 <form METHOD="post" action="montasVi.php" onSubmit="return compForm('c')" class="contacto">
  <div id="campos"> 
    <div class="contacto">
...
<div class="envioPrincipal">
 <form METHOD="post" action="montasVi.php" onSubmit="return compForm('a')" class="contacto">
...
<div id="denunciar-popUp">
			<h3>Formulario de contacto</h3>
			<div class="contactoPrincipal">
 <form METHOD="post" action="montasVi.php"  class="contacto">
  <div id="campos"> 
    <div class="contacto">
