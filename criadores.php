...
if(isset($_POST['actualizar']) && isset($_POST['provincia'])){
	...
	$sqlPro="select telefono, nombreCriador, webCriador from usuarios where webCriador!='' AND nombreCriador!=''".$porProv;
	if($reAd=$db->GetRow($sqlPro)){
	  $infoProtectoras.='<div class="cabeceraProtectorasSub">
									<div class="uno">'.$reAd['nombreCriador'].'</div>
									<div class="dos">'.$reAd['telefono'].'</div>
									<div class="tres">'.$reAd['webCriador'].'</div>
