...
if(isset($_POST['actualizar'])){
  ...
  $sqlAdopciones="select * from anuncios where tipo='cv' ".$sql;
}else{
  $sqlAdopciones="select * from anuncios where idCategoria=1 AND tipo='cv' ORDER BY precio DESC";
}//$db->debug=true;
$anunciosHtml='';
