<?php /* Smarty version 2.6.20, created on 2012-09-22 20:13:02
         compiled from materialVi.tpl */ ?>
 ...
 />
             ...
             <ul class="menuUl">
                ...
                <span class="menuRef">Ordenar precio</span>
                    <span class= "formInputRadio">
                    <input  name="precio" type="radio" id="As" value="asc" <?php echo $this->_tpl_vars['asc']; ?>
 />
                    <label for="As">Ascendente:</label>
                    <input type="radio" name="precio" id="Des" value="desc" <?php echo $this->_tpl_vars['desc']; ?>
/>
