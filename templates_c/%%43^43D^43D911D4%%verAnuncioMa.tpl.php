<?php /* Smarty version 2.6.20, created on 2012-08-17 20:52:19
         compiled from verAnuncioMa.tpl */ ?>
...
var errorNombre, errorEmail, errorText, errorTelefono;
 $(document).ready(function(){ 
        $("ul.menu-secondary").superfish({ pathClass: "current" });
 });
...
<form METHOD="post" action="adopcionesVi.php" onSubmit="return compForm('a')" class="contacto">
            ...
            <input class="input" type="text" name="nombre" id="nombre" value="<?php echo $this->_tpl_vars['nombre']; ?>
"  onblur="valida(this.value, this);"/>
...
" onblur="compEmail(this.value, this)"/>
            </div>
