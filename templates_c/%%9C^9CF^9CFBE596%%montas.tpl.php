<?php /* Smarty version 2.6.20, created on 2012-08-21 16:37:43
         compiled from montas.tpl */ ?>
...
<link href="../css.css" rel="stylesheet" type="text/css" />
 ...
 <?php echo $this->_tpl_vars['numImg']; ?>
...
/>
        ...
        <?php echo $this->_tpl_vars['error']['tamano']; ?>
...
" />
        ...
        <?php echo $this->_tpl_vars['error']['titulo']; ?>
         ...
         <li>
            ...
            <input name="interes" type="text" class= "formInput" placeholder="Un cachorro" id="interes" value="<?php echo $this->_tpl_vars['interes']; ?>
" />
        </li> 
        <?php echo $this->_tpl_vars['error']['interes']; ?>
    ...
    <ul>
    	<li><script type="text/javascript" src="jQuery/jquery.MultiFile.js"></script>
            ...
            <input type="file" name="files[]" id="inImgs" class="multi accept-jpg|gif|png" maxlength="<?php echo $this->_tpl_vars['left']; ?>
"/>
        </li>
        <li class="arrow_box">
        Recuerda que... los anuncios con fotos reciben más visitas (máximo 4 imagenes)
        </li>
        <?php echo $this->_tpl_vars['imagesDel']; ?>
