<?php /* Smarty version 2.6.20, created on 2012-09-09 23:30:17
         compiled from verAnuncio.tpl */ ?>
...
<div class="contenedorForm">
		...
		<div class="visualizacion">
 			<div class="anunciosTitulo"><?php echo $this->_tpl_vars['titulo']; ?>
</div>
 			<div class="anunciosCiudad">Categoria:<span style="color:#666666"> <?php echo $this->_tpl_vars['categoria']; ?>
 </span>Ciudad: <span style="color:#666666">(<?php echo $this->_tpl_vars['ciudad']; ?>
)</span></div>
            <div class="anunciosFecha">Fecha publicacion: <span style="color:#666666"><?php echo $this->_tpl_vars['fechaa']; ?>
</span></div>
           <?php echo $this->_tpl_vars['raza']; ?>

            <?php echo $this->_tpl_vars['precioo']; ?>

            <div style="clear:both"></div>
       	<div id="main">
            <div id="gallery">
                <div id="slides">
                    <?php echo $this->_tpl_vars['htmlImgsG']; ?>
                ...
                <div id="menu">
                    <ul>
                        <li class="fbar">&nbsp;</li>
                        <?php echo $this->_tpl_vars['htmlImgsP']; ?>
	  ...
	  <div class="anunciosMenuB">
          <div class="anunciosMenuBIzquierda">
              <?php echo $this->_tpl_vars['vacDesp']; ?>

              <?php echo $this->_tpl_vars['sexoFin']; ?>

              <?php echo $this->_tpl_vars['edadFin']; ?>

              <?php echo $this->_tpl_vars['interes_']; ?>
		...
		<a href="http://www.facebook.com/sharer.php?u=http://www.anunciamascotas.com/verAnuncio?idAnuncio=<?php echo $this->_tpl_vars['idAnuncio']; ?>
" target="parent"><img src="recursos/formularios/facebook.png" width="15" height="15" alt="compartir" />Compartir</a></span>
        <span class="anunciosContacto"><a href="#" class="enviarPoP" rel="<?php echo $this->_tpl_vars['idAnuncio']; ?>
"><img src="recursos/formularios/check_mark_32x32.png" width="15" height="15" alt="enviar a amigos" />Enviar a amigos</a></span>
...
<div class="contactoPrincipal">
 <form METHOD="post" action="contacto.php" onSubmit="return compForm()" class="contacto">
  <div id="campos"> 
    ...
    <input type="hidden" name="idAnuncio" value="<?php echo $this->_tpl_vars['idAnuncio']; ?>
"/>
    </div>
 ...
 Llamar a <b style="color:#666; size:14px"><?php echo $this->_tpl_vars['nombre']; ?>
</b><br />	
<img src="recursos/formularios/iphone_32x32.png" width="32" height="32" alt="llamar" /><span ><?php echo $this->_tpl_vars['telefono']; ?>
</span>

 
 </div>
 <?php echo $this->_tpl_vars['datosAdop']; ?>
...
<form METHOD="post" action="adopcionesVi.php"  class="contacto">
            ...
            <input class="input" type="text" name="nombre" id="nombre_" value="<?php echo $this->_tpl_vars['nombre']; ?>
"  />
            ...
            <input class="input" type="text" name="email" id="emailAmigo" value="<?php echo $this->_tpl_vars['email']; ?>
" />
            </div>
